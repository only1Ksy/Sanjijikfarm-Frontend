...
export default function ReportPage() {
  return (
    <div className="overflow-y-auto max-h-[82vh] h-screen scrollbar-hide pt-[1.7rem]">
      <h2 className="text-title-3 text-center font-bold">{mockData.month}</h2>
      <ReportSummary
        totalPurchases={mockData.totalPurchases}
        totalReducedCO2={mockData.totalReducedCO2}
      />
